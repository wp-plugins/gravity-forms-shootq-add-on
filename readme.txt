...
3. Open the plugin settings page Gravity Forms -> Settings -> ShootQ
4. Add your ShootQ API Key and Brand Abbreviation
5. Add a "feed" to map the ShootQ fields to your form
4. Start generating leads!

== Frequently Asked Questions ==
= I have more than one brand set up in ShootQ. Will this let me use both? =
Sorry, but no. This is a one brand pony show. The majority of people who have multiple ShootQ brands will also have separate domains for each brand. There are no plans at this time to change the plugin to allow multiple brands per installation.
...
= Where can I get help on getting this thing started? =
